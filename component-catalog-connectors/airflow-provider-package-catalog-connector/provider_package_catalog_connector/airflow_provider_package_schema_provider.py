...
class AirflowProviderPackageSchemasProvider(SchemasProvider):
    ...
    def get_schemas(self) -> List[Dict]:
        """
        Return the Apache Airflow provider catalog connector schema
        """
        # use Elyra logger
        ...
        try:
            ...
            log.debug(f'Reading Airflow provider package catalog connector schema from {catalog_connector_schema_file}')
            ...
            log.error('Error reading Airflow provider package catalog connector '
